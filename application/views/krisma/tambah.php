    ...
    <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tambah Krisma</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <h5 class="card-header">Tambah Data Krisma</h5>
                    <div class="card-body">
                        <form action="<?= base_url('krisma/tambah') ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputText3" type="text" name="nama_penguatan" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputText3" type="text" name="tmpt_krisma" class="form-control">
