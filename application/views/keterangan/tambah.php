        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('keterangan/tambah') ?>" method="POST">
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label"> Buku Perkawinan</label>
                                <input id="inputText3" type="text" name="buku_perkawinan" class="form-control">
